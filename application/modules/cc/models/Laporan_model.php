...
class Laporan_model extends CI_Model {
    ...
    var $select_column      = array('list_laporan.laporan_id','list_laporan.laporan_created_timestamp','list_laporan.laporan_name','list_laporan.laporan_phone_no','list_laporan.laporan_vehicle_category','list_laporan.laporan_problem_category','list_laporan.laporan_plat_no','list_laporan.laporan_ruas_id','list_laporan.laporan_ruas_group_id','list_laporan.laporan_jalur','list_laporan.laporan_description',
    ...
    public function make_query($id)
    {
        ...
        switch($id)
        {
            case 1 :
                ...
                $this->db->where('list_laporan.laporan_forward_to_petugas_timestamp',null);
                $this->db->where_not_in('list_laporan.status_id ', $ignore);
                break;
            case 2 :
                $ignore = array(2,3,4);
                $this->db->where('list_laporan.laporan_forward_to_tic_timestamp !=',null);
                $this->db->where_in('list_laporan.status_id ', $ignore);               
                break;
            case 3 :
                $this->db->where('list_laporan.status_id',5);
                $this->db->or_where('list_laporan.status_id',6);
                break;
        }
